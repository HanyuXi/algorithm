class HashTable(object):
    ...
    This is a minimal implementation of hashtables.
    As you can see, the computation time could be linear, to make it constant, we have to reduct the number of collisions to achive constant time.
    How to reduce # of collisions? we add more buckets
    """
